<script>
	...
	import profile from '$lib/images/black-santy.png';
</script>

<header>
	<div class="corner">
		<a href="https://santy.in">
			<img src={profile} alt="SvelteKit" width="25" height="25" style="border-radius: 25px;"/>
		</a>
	</div>
	...
	<div class="corner">
		<a href="https://github.com/ChintuSanty">
